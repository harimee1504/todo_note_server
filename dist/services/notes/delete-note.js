...
const deleteNote = (payload, context) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const transaction = yield ((_a = notes_1.Note.sequelize) === null || _a === void 0 ? void 0 : _a.transaction());
    try {
        const deletedRowsCount = yield notes_1.Note.destroy({ where: { id: payload.input.id, org_id: context.req.auth.orgId }, transaction });
        ...
        console.error(error);
        throw new utils_1.CustomError('Failed to delete note.');
    }
});
