...
const updateTag = (payload, context) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    try {
        ...
        const [updatedRowsCount] = yield tags_1.default.update(data, {
            where: {
                id: data.id,
                org_id: context.req.auth.orgId,
            },
        ...
        if (updatedRowsCount === 0) {
            ...
            throw new utils_1.CustomError('Tag not found.');
        }
        const tag = yield tags_1.default.findByPk(data.id, { transaction });
        if (!tag) {
            yield (transaction === null || transaction === void 0 ? void 0 : transaction.rollback());
            throw new utils_1.CustomError('Tag not found after update.');
        }
