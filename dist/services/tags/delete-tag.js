...
const deleteTag = (payload, context) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const transaction = yield ((_a = tags_1.default.sequelize) === null || _a === void 0 ? void 0 : _a.transaction());
    try {
        const deletedRowsCount = yield tags_1.default.destroy({ where: { id: payload.input.id, org_id: context.req.auth.orgId } });
        ...
        console.error(error);
        throw new utils_1.CustomError('Failed to delete tag.');
    }
});
