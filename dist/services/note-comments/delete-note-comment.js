...
exports.deleteNoteComment = void 0;
const utils_1 = require("../../utils/utils");
const note_comments_1 = __importDefault(require("../../models/notes/note-comments"));
const deleteNoteComment = (payload, context) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const transaction = yield ((_a = note_comments_1.default.sequelize) === null || _a === void 0 ? void 0 : _a.transaction());
    try {
        const deletedRowsCount = yield note_comments_1.default.destroy({ where: { id: payload.input.id, org_id: context.req.auth.orgId }, transaction });
        ...
        throw new utils_1.CustomError('Failed to delete note comments.');
    }
});
